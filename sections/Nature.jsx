    ...
    <section className="flex items-center xl:h-screen px-10">
      <div className="mt-32 grid grid-cols-1 xl:grid-cols-3 gap-10 relative">
        <div className="flex justify-center gap-5">
          <img src="/nature/nature-3.jpg"  className="w-[100px] h-[150px] md:w-[200px] md:h-[250px] object-cover object-center" />
          <img src="/nature/nature-4.jpg" className="mt-10 w-[100px] h-[150px] md:w-[250px] md:h-[300px] object-cover object-center" />
        </div>
        <div>
        ...
        <div className="flex flex-wrap justify-center gap-5">
          <img src="/nature/nature-8.jpg" className="xl:ml-10 h-[100px] w-[150px] md:h-[200px] md:w-[300px] object-cover" />
          <img src="/nature/nature-12.jpg" className="h-[150px] w-[100px] md:h-[200px] md:w-[150px] object-cover" />
          <img src="/nature/nature-1.jpg" className="w-[150px] h-[100px] md:w-[250px] md:h-[150px] object-cover" />
          <Link 
