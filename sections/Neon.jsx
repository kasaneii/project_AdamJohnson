    ...
    <section className="flex items-center xl:h-screen px-10">
      <div className="mt-32 grid grid-cols-1 xl:grid-cols-3 gap-20 relative">
        <div className="flex flex-wrap justify-center gap-5">
          <img src="/neon/neon-1.jpg" className="mt-24 w-[150px] h-[250px] md:w-[200px] md:h-[300px] object-cover object-center" />
          <img src="/neon/neon-2.jpg" className="w-[150px] h-[250px] md:w-[200px] md:h-[300px] object-cover object-center" />
        </div>
        <div>
        ...
        <div className="flex flex-wrap justify-center gap-5">
          <img src="/neon/neon-6.jpg" className="xl:ml-36 h-[100px] w-[200px] md:h-[150px] md:w-[250px] object-cover" />
          <img src="/neon/neon-9.jpg" className="h-[250px] w-[150px] md:h-[300px] md:w-[200px] object-cover" />
          <img src="/neon/neon-10.jpg" className="mt-10 h-[100px] w-[150px] md:h-[150px] md:w-[200px] object-cover object-top" />
          <Link 
