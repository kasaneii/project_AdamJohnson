    ...
    <section className='flex items-center xl:h-screen px-10'>
      <div className="mt-32 grid grid-cols-1 xl:grid-cols-3 gap-20 relative">
          <div className="flex justify-center gap-5">
            <img 
              src="/portrait/portrait-2.jpg" 
              className="mt-56 w-[100px] h-[150px] md:w-[150px] md:h-[200px] object-cover object-center"
              />
            <img 
              src="/portrait/portrait-3.jpg" 
              className="w-[200px] h-[300px] md:w-[300px] md:h-[400px] object-cover object-center"
              />
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-5">
            <img 
              src="/portrait/portrait-7.jpg" 
              className="h-[200px] w-[100px] md:h-[300px] md:w-[200px] object-cover"
              />
            <img 
              src="/portrait/portrait-4.jpg" 
              className="w-[100px] h-[100px] md:h-[200px] md:w-[200px] object-cover"
              />
            <img 
              src="/portrait/portrait-9.jpg" 
              className="w-[200px] h-[100px] md:h-[200px] md:w-[300px] object-cover"
              />
            <Link 
