      ...
      <div className="mt-32  grid grid-cols-1 xl:grid-cols-3 gap-10 relative">
          <div className="flex flex-wrap justify-center gap-5">
            <img
              ...
              className="w-[100px] h-[150px] md:w-[150px] md:h-[200px] object-cover object-center"
              />
            <img
              src="/street/street-2.jpg" 
              className="w-[150px] h-[100px] md:w-[200px] md:h-[150px] object-cover object-center"
              />
            <img
              src="/street/street-4.jpg" 
              className="w-[150px] h-[150px] md:w-[200px] md:h-[200px] object-cover object-center"
              />
            <img
              src="/street/street-6.jpg" 
          ...
          <div className="flex flex-wrap justify-center gap-5">
            <img
              src="/street/street-8.jpg" 
              className="w-[300px] h-[400px] md:h-[500px] md:w-[400px] object-cover"
              />
            <Link 
